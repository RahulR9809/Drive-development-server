...
userRouter.post("/stripe/confirmpayment", async (req, res, next) =>
  controllers.confirmStripePayment.confirmPayment(req, res, next)
);
...
userRouter.get(
  ...
  async (req, res, next) =>
    controllers.getTripDetailByIdController.getTripDetailById(req, res, next)
);
userRouter.get(
  "/walletbalance/:userId",
  AuthHandler.isUserLogin,
  async (req, res, next) =>
    controllers.getWalletBalanceController.getWalletBalance(req, res, next)
);
userRouter.post(
  "/wallet-addmoney",
  AuthHandler.isUserLogin,
  async (req, res, next) =>
    controllers.addMoneytoWalletController.addMoney(req, res, next)
);
userRouter.get(
  "/wallethistory",
  AuthHandler.isUserLogin,
  async (req, res, next) =>
    controllers.getWalletHistoryController.getWalletHistory(req, res, next)
);
userRouter.post("/payment", AuthHandler.isUserLogin, async (req, res, next) =>
  controllers.paymentController.payment(req, res, next)
);
