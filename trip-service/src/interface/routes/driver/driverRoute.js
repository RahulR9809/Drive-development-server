...
import { GetAllTripsController } from "../../controllers/driverController/getAllDriverTripsController.js";
import { TripDetailsController } from "../../controllers/driverController/tripDetailsController.js";
...
const controllers = {
  ...
  getAllDriverTripsController: new GetAllTripsController(dependencies),
  getTripDetails: new TripDetailsController(),
};
...
driverRouter.put(
  ...
  async (req, res, next) => {
    controllers.getOnlineController.getOnline(req, res, next);
  }
);
driverRouter.put(
  "/offline",
  AuthHandler.isDriverLogin,
  async (req, res, next) => {
    controllers.getOfflineController.getOffline(req, res, next);
  }
);
driverRouter.post(
  "/accept-ride",
  AuthHandler.isDriverLogin,
  async (req, res, next) => {
    controllers.rideAcceptController.acceptRide(req, res, next);
  }
);
driverRouter.post(
  "/reject-ride",
  AuthHandler.isDriverLogin,
  async (req, res, next) => {
    controllers.rideRejectController.rejectRide(req, res, next);
  }
);
driverRouter.post(
  "/start-ride",
  AuthHandler.isDriverLogin,
  async (req, res, next) => {
    controllers.startRideController.startRide(req, res, next);
  }
);
driverRouter.post(
  "/complete-ride",
  AuthHandler.isDriverLogin,
  async (req, res, next) => {
    controllers.rideCompleteController.completeRide(req, res, next);
  }
);
driverRouter.get(
  "/tripcount",
  AuthHandler.isDriverLogin,
  async (req, res, next) =>
    controllers.tripCountController.tripCount(req, res, next)
);
driverRouter.get(
  "/top-trips/:driverId",
  AuthHandler.isDriverLogin,
  async (req, res, next) =>
    controllers.topTripsController.topTrips(req, res, next)
);
driverRouter.get(
  "/completedtrip-count/:driverId",
  AuthHandler.isDriverLogin,
  async (req, res, next) =>
    controllers.getCompletedTripsCount.getCompletedTripsCount(req, res, next)
);
driverRouter.get(
  "/latest-trips/:driverId",
  AuthHandler.isDriverLogin,
  async (req, res, next) =>
    controllers.getLatestTripsController.latestTrips(req, res, next)
);
driverRouter.get("/trips", AuthHandler.isDriverLogin, async (req, res, next) =>
  controllers.getAllDriverTripsController.getDriversTrips(req, res, next)
);
driverRouter.get(
  "/tripdetails/:driverId",
  AuthHandler.isDriverLogin,
  (req, res, next) => {
    console.log("hhjhhhhhhhh");
    next();
  },
  async (req, res, next) =>
    controllers.getTripDetails.tripDetailsController(req, res, next)
);
